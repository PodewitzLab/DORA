...
f.descriptor_data, self.distance_data, self.dE_data, [self.TdS_A, self.TdS_B, self.TdS_AB]]
    ...
    for ax in axs:
        ...
        ax[0].set_xlabel("$r_{A \cdot \dot B}$ / $\AA$", fontsize=fontsize)
    ...
    if savepath != "":
        ...
        plt.savefig(savepath + "plots/" + D_name + "_" + str(gamma_cleave) + ".png", dpi=500, bbox_inches="tight")
        plt.show()
